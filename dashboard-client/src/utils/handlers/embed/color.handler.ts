...
export const ColorHandlerInInput = (event: FormEvent<HTMLTextAreaElement|HTMLInputElement>, id: string) =>
{
...
export const ColorHandlerInTextarea = (e: FormEvent<HTMLTextAreaElement|HTMLInputElement>, id: string, styles: any) =>
{
...
export const MainColorHandler = (e: FormEvent, valueId: string, id: string, styles: any) =>
{
    const document = e.currentTarget.ownerDocument;

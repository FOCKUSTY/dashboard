...
export const formatSettings = <T extends string>(settings: T[] | readonly T[]) =>
  settings.map((string: T) => format(
    string
      .toLowerCase()
      .replaceAll("__", " ")
      .replaceAll("_", " ")
...
export namespace Settings {
  ...
  export namespace Guild {
    export const EXCLUDE = [
      ...
      "WHEN_USER__JOIN_INTO_GUILD__SEND_HELLO_MESSAGE_INTO_CHANNEL",
      "WHEN_USER__LEAVE_FROM_GUILD__SEND_GOODBYE_MESSAGE_INTO_CHANNEL",
